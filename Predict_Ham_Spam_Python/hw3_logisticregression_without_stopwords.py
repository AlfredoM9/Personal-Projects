...
# Class : CS 6375.001
# Date  : 10/16/20
# Descr : This is logistic regression without stop words. This program follows the instructions given in the assignment
#         3 description. It reads the training files from the spam and ham folder. It then tokenizes each document
...
def get_weights(vocab, data_set, mu_value, lambda_value, iterations):
    ...
    weights = np.array([1 for i in range(len(vocab) + 1)])
