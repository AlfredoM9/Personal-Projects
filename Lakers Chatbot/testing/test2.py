...
def main():
    while True:
        raw = wikipedia.search('Kobe')
        print(raw)
        raw = wikipedia.page("Lebron")
        raw = raw.content
        ...
        raw_input = input()
        subject = nltk.sent_tokenize(raw_input)

        sent_tokens = sent_tokens + subject
        ...
        print(arry)
        print(max)
        print(sent_tokens[index])
        #
        # custom_tweet = raw_input
        #
